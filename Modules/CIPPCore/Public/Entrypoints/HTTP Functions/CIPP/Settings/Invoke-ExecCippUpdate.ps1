function Invoke-ExecCippUpdate {
    ...
    try {
        ...
        if (-not $GitHubConfig.Enabled) {
            throw 'The GitHub extension is not configured. Please enable it and provide a Personal Access Token with "repo" and "workflow" scopes under Settings > Extensions > GitHub to use the update button.'
        }
